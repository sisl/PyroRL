...
Wind components
"""
# The rate with which speed of wind converts to a percent change
# in the chance of a neighbor cell igniting the center cell
...
# direction of the corresponding neighboring cell
...
def linear_wind_transform(wind_speed: float, wind_angle: float) -> torch.Tensor:
    ...
    scaling_term = (
        -(neighbor_vectors @ wind_vector) * speed_to_percent_ratio * wind_speed + 1
    )
